  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-full px-6 py-8 sm:py-12 md:pl-16 lg:pl-24">
        ...
        <button className="bg-[#08A8FD] text-white px-6 py-2 text-lg roboto-regular rounded-full hover:text-gray-800 transition lg:mt-4">
          <a href="#services">{t("home.button")}</a>
        </button>
      </div>
    </div>
  );
