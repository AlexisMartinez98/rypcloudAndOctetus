...
const About = () => {
  ...
  return (
    <div
      id="about"
      className=" roboto-regular bg-[#393939] px-4 py-8 text-white flex flex-col md:px-16 lg:px-0 md:bg-[#EBEBEB] md:text-black"
    >
      ...
      <div className=" p-4 flex flex-col md:flex md:flex-row md:gap-4 md:justify-center">
        ...
        <div className="flex flex-col md:w-1/2 ">
          ...
          <div className=" flex justify-center md:justify-start mt-8">
            <button className="bg-[#08A8FD] text-lg p-3 px-10 rounded-full w-full md:w-1/2 lg:w-1/3 text-white">
              <a href="#contact">{t("about.button")}</a>
            </button>
          </div>
        </div>
      </div>
